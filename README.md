...
actual Version V1.0.3
-print a message for new user of discord server
-new commande /salut print "bonjour a toi + member name"
-detect les gros mots, notes dans un fichier de log et signale la personne au bout de 3 gros mots
-affiche les docker tournant et peut en lancer
